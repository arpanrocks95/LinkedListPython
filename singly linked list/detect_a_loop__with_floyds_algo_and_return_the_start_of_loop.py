    ...
    def returnNodeAtPos(self,pos):
        ...
        if pos is 1:
            ...
            for i in range(1,pos):
                temp = temp.next
        return temp
    def detetcALoopInsideLinkedListWithFloydsAlgoandReturnStart(self):
        temp = self.head
        fasttemp = self.head
        desc = 0
...
if __name__=='__main__':
    ...
    startNode = ll.detetcALoopInsideLinkedListWithFloydsAlgoandReturnStart()
    print("data in the start node is {0}".format(startNode.data))